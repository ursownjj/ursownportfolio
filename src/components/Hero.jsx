    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Hi, I'm <span className="blue-text-gradient">Joshva Joshy</span>
          </motion.h1>
          <motion.p
            variants={textVariants}
            className={`${styles.heroSubText} mt-2 text-white-100`}
          > <div><audio controls autoPlay hidden  loop src="Audo.mp3" type="audio/mpeg">
          </audio>
          </div>
            I am a Full Stack Developer <br className="sm:block hidden" />
           <p> Front-end finesse, back-end brilliance.</p>
          </motion.p>
